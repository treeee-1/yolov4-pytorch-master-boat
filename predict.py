...
if __name__ == "__main__":
    ...
    overlap_cols = 80
    overlap_rows = 50
    yolo.crop_one_picture(path, filename, cols, rows, overlap_cols, overlap_rows)

    dir_origin_path = "tif/crop880_650"
    ...
    if mode == "predict":
        ...
        for end in range(bs, len(img_names), bs):
            ...
            r_image = yolo.detect_image_batch(input_images,W, H, cols, rows, sum_cols, sum_rows, overlap_rows, overlap_cols)
